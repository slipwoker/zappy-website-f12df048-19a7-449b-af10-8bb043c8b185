    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חברת עגורני הצריח הגדולה בישראל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f12df048-19a7-449b-af10-8bb043c8b185',
                    name: data.name || '',
                    email: data.email || '',
